...
def create_quiz_prompt(quiz_data: QuizPrompt, teacher_id: str, values_language: str = 'english') -> str:
    ...
    The data in the quiz should be of the language: {values_language}. The keys of the schema should remain english, but the data inside it should be of {values_language}
    """
